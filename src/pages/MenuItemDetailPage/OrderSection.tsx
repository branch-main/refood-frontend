...
export const OrderSection = ({ item, onOrder }) => {
    ...
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
      <div className="p-6 space-y-5">
        ...
        <Button
          ...
          fullWidth
          className="!py-3.5 !px-6 !text-base !font-semibold !bg-[#B21F1F] hover:!bg-[#8B1616] !text-white !rounded-lg !transition-colors !shadow-sm hover:!shadow"
        >
