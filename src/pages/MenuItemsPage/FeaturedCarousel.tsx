                ...
                <div className="grid grid-cols-1 md:grid-cols-2 h-full items-center">
                  ...
                  <div className="flex flex-col justify-center items-start p-6 md:p-8 gap-3 h-full min-h-0">
                    ...
                    <button
                      ...
                      className="bg-linear-to-r from-[#B21F1F] to-[#8B1616] text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5 text-sm mt-2"
                    >
                      Ver Oferta
                    </button>
                  </div>
