  ...
  return (
    <footer className="bg-gray-800 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-8 py-12 grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-8">
        <div>
          <h3 className="text-2xl mb-4">ReFood</h3>
        ...
        <div>
          ...
          <ul className="list-none p-0">
            <li className="mb-2">
              <a
                href="/menu"
                className="text-gray-400 no-underline transition-colors duration-200 hover:text-[#B21F1F]"
              >
                Explorar Alimentos
              </a>
            </li>
      ...
      <div className="border-t border-gray-700 text-center py-6 text-gray-400">
        <p>&copy; 2024 ReFood. Todos los derechos reservados.</p>
      </div>
    </footer>
  );
};
